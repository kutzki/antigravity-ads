...
```bash
python C:\Users\kutzk\.gemini\antigravity\skills\claude-C:\Users\kutzk\.gemini\antigravity\skills\claude-ads\scripts\capture_screenshot.py [url]
```
Saves: `./brand-screenshots/{domain}_homepage.png`

2. **Product or services page**:
```bash
python C:\Users\kutzk\.gemini\antigravity\skills\claude-C:\Users\kutzk\.gemini\antigravity\skills\claude-ads\scripts\capture_screenshot.py [url]/products
```
Saves: `./brand-screenshots/{domain}_product.png`

3. **About page** (brand personality):
```bash
python C:\Users\kutzk\.gemini\antigravity\skills\claude-C:\Users\kutzk\.gemini\antigravity\skills\claude-ads\scripts\capture_screenshot.py [url]/about
```
...
Read `C:\Users\kutzk\.gemini\antigravity\skills\claude-C:\Users\kutzk\.gemini\antigravity\skills\claude-ads\references\brand-dna-template.md` for the exact schema.
