...
2. Read `C:\Users\kutzk\.gemini\antigravity\skills\claude-ads\references\benchmarks.md` for industry CPC/CTR/CVR baselines
...
> **MCP Integration**: For live API access to competitor data sources, see `C:\Users\kutzk\.gemini\antigravity\skills\claude-ads\references\mcp-integration.md`.
